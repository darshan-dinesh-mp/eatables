...
<body>
     <div class="bg-brand min-h-screen bg-img bg-fixed w-full flex flex-col items-center p-4 md:py-0 md:px-16">
          ...
          <div class="flex flex-col items-center justify-center w-full pt-8 md:pt-12">
               <div class="relative">
                    <a href="edit-profile.php"
                         class="flex items-center justify-center absolute bottom-0 right-0 z-10 p-3 bg-black/80 hover:text-[#f9bb21] duration-300 w-8 h-8 text-white rounded-full">
          ...
          if ($review_id == null) {
               ...
               ?>
                    <div
                         class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 gap-5 place-content-evenly py-8 w-full md:w-4/6">
                         <?php
