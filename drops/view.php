                ...
                <div class="bg-black overflow-hidden bg-fixed w-full flex flex-col items-center">
                    ...
                    <div class="flex flex-col items-center justify-center w-full">
                        ...
                        <div class="md:w-[30rem] md:h-[100vh] h-full shadow-2xl relative ">
                            <video controls id="video-<?= $video['drop_id'] ?>"
                                class="re playable-video md:w-[30rem] md:h-[100vh] object-cover" data-no-fullscreen="true"
                                src="../drops/uploads/<?php echo $video["video_url"]; ?>"></video>
                            <div
                                class="w-full h-36 px-2 md:px-5 flex justify-between absolute z-50 bottom-0 font-poppy bg-gradient-to-t from-black text-white">
                                <div class="flex flex-col w-3/4">
                                    <div class="flex items-center my-2 space-x-2">
                                        <img class="w-8 md:w-10 h-8 md:h-10 rounded-full" src="<?php echo $image ?>" />
                                        <h1 class=' text-sm md:text-xl text-white'>
                                            <?php echo $video["fullname"]; ?>
                                        </h1>
                                    </div>
                                    <p class="md:text-lg text-sm">
                                        <?php echo $video["hotel_name"] ?>
                                    </p>
                                </div>
    ...
    ?>
            ...
            <div id="modal" class="modal">
                <div class="modal-content">
                    <form action='upload.php?review=2' method="post" enctype="multipart/form-data"
                        ...
                        <button
                            class="py-[0.50rem] md:py-[0.70rem] tracking-wider px-9 md:px-12 text-xl font-poppy duration-500 close hover:bg-black/30 rounded-xl"><i
