...
<body>
	...
	<div class="bg-brand bg-img min-h-screen flex flex-col items-center p-4 md:px-16">
		...
		<div class="flex justify-between md:py-6">
			<div class='w-3/6'>
				<h1 class='font-poppy text-3xl font-bold'><?php echo $hotel_name ?></h1>
			...
			<div class='w-2/6'>
				<h1 class='font-poppy text-xl font-bold'><i class="fa-sharp fa-solid fa-location-dot mr-1 mb-2"></i>locate on map</h1>
